                ...
                <v-dialog v-model="dialog" persistent max-width="500">
                    ...
                    <v-card>
                        ...
                        <div class="ma-5">
                            ...
                            hover length="5" size="25" v-model="rating" ref="rating"></v-rating>
                        </div>
                         
                        <v-card-actions>
                        <v-spacer></v-spacer>
                        <v-btn color="#FF0000" text @click="dialog = false"> Cancelar </v-btn>
                        <v-btn style="color: #114B5F;" color="#CAF1FF" text @click="adicionarResenha"> Enviar </v-btn>
                        </v-card-actions>
                    </v-card>
                </v-dialog>
            </div>
                    ...
                    <div class="d-flex justify-center flex-column ">
                        <v-card class="rounded-lg ma-5" elevation="4" color="#114B5F" style="width: 35rem;" 
                            ...
                            <v-col class=" d-flex align-center">
                                ...
                                <h4 class="font-weight-light" style="color: #FFF;">{{ comentario.titulo }}</h4>
                                <v-spacer></v-spacer>
                                <v-rating class="" style="" background-color="#F1C40F" color="#F1C40F" empty-icon="mdi-star-outline" full-icon="mdi-star" half-icon="mdi-star-half-full" 
                                hover length="5" readonly size="25" :value="comentario.estrela"></v-rating> 
                            </v-col>
...
export default {
    ...
    data: () => ({ 
      ...
      novaResenha: "",
      resenha: [
        { descricao: "livro muito bomlivro muito bomlivro muito bom", titulo: "gostei do livro", estrela: 3},
